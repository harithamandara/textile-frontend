...
`;
  ...
  `;
    ...
    async fetchProductDetails() {
      try {
        const response = await fetch(
          `https://localhost:7176/api/Product/GetAllProducts`
        );
        if (!response.ok) {
          throw new Error(
    ...
    addProduct() {
      ...
      fetch("https://localhost:7176/api/Product/PostProducts", {
        method: "POST",
        headers: {
    ...
    deleteProduct(productId) {
      ...
      if (index !== -1) {
        ...
        fetch(`https://localhost:7176/api/Cart/GetAllCartProducts`)
          .then((response) => {
            if (!response.ok) {
              throw new Error(
          ...
          .then((cartProducts) => {
            ...
            if (productInCart) {
              ...
              fetch(
                `https://localhost:7176/api/Product/DeleteProducts?productId=${productId}`,
                {
                  method: "DELETE",
                }
              )
    ...
    updateProduct(updatedProduct) {
      ...
      fetch("https://localhost:7176/api/Product/UpdateProducts", {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
